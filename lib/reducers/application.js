...
const actionHandlers = {
  ...
  [constants.RESET_MESSAGES]: (_, action) => ({error: null, success: null}),
  [constants.PAGE_TITLE]: (_, action) => ({ title: action.title }),
  [constants.SIDEBAR_VISIBILITY]: (_, action) => ({ isSidebarActive: action.visible }),
  ...
  [constants.UPDATE_TREE]: (_, action) => ({tree: action.tree})
}
