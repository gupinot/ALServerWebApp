...
export default class Datalist extends React.Component {
  ...
  constructor(props) {
    super(props)
    this.state = { data: this.props.dimension.top(this.props.maxItems) || this.props.data}
  }

  _refresh() {
    dc.events.trigger(() => this.setState({ data: this.props.dimension.top(this.props.maxItems) || this.props.data }))
  }

  componentWillReceiveProps(nextProps) {
    if (nextProps.data && nextProps.data !== this.props.data) {
      this.setState({ data: nextProps.dimension.top(nextProps.maxItems) || nextProps.data })
    }
  }
